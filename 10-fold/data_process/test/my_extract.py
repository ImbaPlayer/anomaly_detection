...
def main():
    ...
    # for i in range(1, 60):
    #     if i < 10:
    #         load_path = "/data/xgr/sketch_data/caida_dirB/equinix-nyc.dirB.20190117-130{}00.UTC.anon.pcap".format(i)
    #     else:
