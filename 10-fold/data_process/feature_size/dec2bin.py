...
# @Last Modified time: 2020-11-16 19:18:32
...
def main(num):
    ...
    fileName = "/data/sym/anomaly_detection/data/10-fold/{}/dec-feature/{}-{}.csv".format(data_type, data_type, num)
    saveName = "/data/sym/anomaly_detection/data/10-fold/{}/bin-feature/{}-{}.csv".format(data_type, data_type, num)
    ...
    statistic_names.extend(["mean", "var", "min", "max"])
