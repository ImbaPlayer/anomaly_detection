...
# @Last Modified time: 2020-11-30 19:57:51
...
def main(num):
    ...
    fileName = "/data/dgl/anomaly_detection/data/10-fold/{}/dec-stat/{}-{}.csv".format(data_type, data_type, num)
    saveName_5 = "/data/dgl/anomaly_detection/data/10-fold/{}/bin-5/{}-{}.csv".format(data_type, data_type, num)
    saveName_stat = "/data/dgl/anomaly_detection/data/10-fold/{}/bin-stat/{}-{}.csv".format(data_type, data_type, num)
    # fileName = "/data/dgl/one-class-svm/data/mean_of_five/dec-feature/univ1-50W-{0}-{1}.csv".format(5, num)
    # saveName = "/data/dgl/one-class-svm/data/mean_of_five/bin-feature/univ1-50W-{0}-{1}.csv".format(5, num)
    # fileName = "size-1.csv"
    # saveName = "size-2.csv"
