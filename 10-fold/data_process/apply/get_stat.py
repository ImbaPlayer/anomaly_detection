...
# @Last Modified time: 2020-11-18 15:12:19
import pandas as pd
...
def new_extract(num):
    ...
    inputName = "/data/sym/one-class-svm/data/mean_of_five/packet-level/caida-A-50W-{}.csv".format(0)
    saveName = "/data/sym/anomaly_detection/test/data/stat/0-1.csv"
    #指定分隔符为/t
